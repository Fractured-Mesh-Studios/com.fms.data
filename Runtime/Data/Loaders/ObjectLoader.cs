...
namespace DataEngine.Data
{
    public class ObjectLoader : MonoBehaviour
    {
        ...
        [HideInInspector] public bool encryption = false;
        ...
        private void Initialize()
        {
            ...
            switch (mode)
            {
                case LoadMode.UseId: name = $"{id}.data"; break;
                case LoadMode.UseName: name = $"{GetHierarchyPath()}.data"; break; 
                case LoadMode.UseFileName: name = $"{fileName}.data"; break;
        ...
        private void OnLoad()
        {
            m_data = m_file.Load<SerializedData>(encryption);
                ...
                for (int i = 0; i < components.Count; i++)
                {
                    ...
                    if (type.Name == Key)
                    {
                        ...
                        for (int f = 0; f < field.Length; f++)
                        {
                            ...
                            {
                                Debug.Log($"Ignored Key: {name}", gameObject);
                            }
                        }
